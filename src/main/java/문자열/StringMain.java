package 문자열;
// 문자열 : Sring, 참조 타입의 자료형
// 문자열 표현을 위해서, 객체를 만들거나, 리터럴 표기 방식으로 사용 (대부분이 경우 리터럴 표기 방식을 사용)
...
//        String text1 = new String("Hello Java"); // 권장되지 않는 방식
        ...
        // indexOf() : 문자열애소 부분 문자열의 시작되는 인덱스 반환
        String text4 = "안녕하세요. 자바 입니다. 오늘도 화이팅";
        System.out.println(text4.indexOf("자바다")); // 찾지 못하면 -1

        // contains() : 문자열에서 부분 문자열이 포합되어 있는지를 리턴
        System.out.println(text4.contains("오늘도"));

        // charAt() : 문자열에서 특정 문자를 반환
        System.out.println(text4.charAt(3));

        // replace() : 문자열에서 부분 문자열을 다른 문자열로 대체하거나 지울 떄 사용
        ...
        String text7 = "안녕하세요. 자바 파이썬 자바스크립스 입니다.";
        ...
        String text9 = "       자바 프르그래밍      ";
        System.out.println(text9.trim());

        // split() : 문자열을 특정 구분자 기준으로 자름
        String timeFormet = "23:45:69";
        String[] strArr = timeFormet.split(":"); // ":"기준으로 잘라서 부분 문자열로 만듬
        System.out.println(strArr[0] + "시" + strArr[1] + "분" + strArr[2] + "초");

        // 문자열 포매팅 : 문자열에 내에 어떤 값을 삽입 하는 것 , printf()문과 거의 유사
