...
// switch : 조건문의 일종, if문은 조건식이 올 수 있지만, 조건식이 올 수 없고, 값만 올 수 있음
// 조건의 값으로는 정수, 문자, 문자열이 올 수 있고, 실수는 안됨
// 조건에 대한 수행 이후 반드시 break 문이 필요함
public class SwitchMain {
    public static void main(String[] args) {
        ...
        switch (season){
            ...
            case "summer":
                System.out.println("여름휴가가 기다려지는 여름 입니다.");
                break;
            case "fall":
            case "autumn":
            ...
            case "winter":
                ...
                break;
            default:  // 위의 모든 조건을 만족하지 않을 경우 수행 됨
