package 열거클래스;
// 열거 타입 : 한정된 상수 집합을 정의 할 수 있는 창조 타입
// - 비교시 값 뿐만 아니라 타입도 검사
// - 기존의 public static final 상수를 대처하기도 함
...
public class EnumMain {
    public static void main(String[] args) {
        // 스캐너로 개발자 5명에 대해서 정보를 입력 받아 한번에 출력하기
        ...
        for (int i = 0; i < 5; i++) {
            ...
            switch (in) {
                case 1:
                    type = DevType.FRONTEND;
                    break;
                case 2:
                    type = DevType.BACKEND;
                    break;
                case 3:
                ...
                case 5:
                    ...
                    break;
                default:
                    System.out.println("잘못된 번호를 입력했습니다. 프로그램 종료");
            }
